...
cl /nologo /EHsc /std:c++17 /utf-8 /Zi /I"%ROOT%\ThirdParty\include" /I"%ROOT%\source" /I"%ROOT%\engine\source" "%SRCFILE%" "%ROOT%\source\Game.cpp" "%ROOT%\engine\source\Application.cpp" "%ROOT%\engine\source\CreatorEngine.cpp" /Fe:"%ROOT%\Bin\main.exe" /link /LIBPATH:"%ROOT%\ThirdParty\lib" glew32.lib glfw3dll.lib opengl32.lib
